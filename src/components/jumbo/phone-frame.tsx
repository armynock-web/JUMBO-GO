      ...
      ? [
          ...
          },
          {
            ...
            items: [
              ...
              { id: "job-detail", label: "U16 — รายละเอียดงาน" },
              { id: "notifications", label: "U18 — แจ้งเตือน" },
              { id: "profile", label: "U17 — บัญชีของฉัน" },
        ...
        ? [
            ...
            },
            {
              ...
              items: [
                ...
                { id: "driver-job-detail", label: "D16 — รายละเอียดงาน" },
                { id: "driver-earnings", label: "D17 — รายได้" },
                { id: "driver-history", label: "D18 — ประวัติงาน" },
                { id: "driver-profile", label: "D19 — โปรไฟล์ Driver" },
        ...
        : [
            ...
            },
            {
              ...
              items: [
                ...
                { id: "admin-driver-detail", label: "A05 — รายละเอียดคนขับ" },
                { id: "admin-kyc", label: "A06 — ตรวจ KYC" },
                { id: "admin-vehicles", label: "A08 — รถ" },
                { id: "admin-jobs", label: "A09 — งานทั้งหมด" },
                { id: "admin-job-detail", label: "A10 — รายละเอียดงาน" },
                { id: "admin-pricing", label: "A11 — ตั้งค่าราคา" },
                { id: "admin-payments", label: "A12 — การชำระเงิน" },
                { id: "admin-reports", label: "A13 — รายงาน" },
                { id: "admin-notifications", label: "A14 — การแจ้งเตือน" },
                { id: "admin-settings", label: "A15 — ตั้งค่าระบบ" },
              ],
            },
          ];
